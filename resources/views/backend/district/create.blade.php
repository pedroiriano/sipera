    ...
    <div class="row gx-4">
        <div class="col-lg-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <input class="form-control" id="district" name="district" type="text" placeholder="Masukkan Nama Kecamatan (contoh: Pancoran Mas)" />
                </div>
            </div>
            <div class="card mb-4">
                <div class="card-header">Alamat</div>
                <div class="card-body">
                    <textarea class="form-control" id="address" name="address" rows="4" placeholder="Masukkan Alamat Kecamatan (contoh: Jl. Kartini Kota Depok)"></textarea>
                </div>
            </div>
        </div>
        <!-- Sticky Navigation-->
