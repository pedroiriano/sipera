            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-auto mt-4">
                    <h1 class="page-header-title">
                        ...
                        Tabel Monitoring Permasalahan Penyerapan Anggaran Kegiatan
                    </h1>
                    <div class="page-header-subtitle">Data Utama Monitoring Permasalahan Penyerapan Anggaran Kegiatan</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-header">
            <div class="row">
                <div class="col-12 text-start">
                    Monitoring Permasalahan Penyerapan Anggaran Kegiatan
                </div>
            </div>
        </div>
        <div class="card-body">
