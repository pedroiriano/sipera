    ...
    <div class="row gx-4">
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <input class="form-control" id="physic" name="physic" type="text" placeholder="Masukkan Target Kinerja (contoh: 83 Orang atau 17 Dokumen)" value="{{ $sub->physic }}" required />
                </div>
            </div>
            @if ($user->role_id == 1)
            <div class="card mb-4">
