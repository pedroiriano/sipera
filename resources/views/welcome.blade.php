        ...
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8 col-lg-10 text-center">
                    ...
                    <h1 class="page-header-ui-title fw-bold text-white text-shadow">SIPERA</h1>
                    <p class="page-header-ui-text fw-bold mb-5 text-white text-shadow">Sistem Informasi Pelaporan Capaian Kinerja</p>
                    @auth
